<%@ Page Title="" Language="C#" MasterPageFile="~/modelo.master" AutoEventWireup="true" CodeFile="mercadoria.aspx.cs" Inherits="mercadoria" %>
    ...
    <div class="row">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-offset-1 col-xs-10 col-sm-offset-0 col-sm-4">
                <asp:TextBox ID="txtCodigo" runat="server" required="required" pattern="^[0-9A-Z]{6,}$" class="form-control" placeholder="Exemplo: RR759C" autofocus data-error="Somente letras e números sem espaços (Mínimo 6 caracteres)."></asp:TextBox>
        ...
        <div class="form-group">
            <div class="col-xs-offset-1 col-xs-10 col-sm-offset-4 col-sm-4">
                <asp:Button ID="btnConfirmar" runat="server" Text="Confirmar" class="btn btn-lg btn-primary btn-block" type="submit" OnClick="btnConfirmar_Click1" />
            </div>
        </div>
        <!--//Botão Confirmar-->
    </div>
